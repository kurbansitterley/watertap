...
from watertap.property_models.air_water_equilibrium_properties import (
    AirWaterEq,
...
def test_properties1(m1):
    ...
    stream.saturation_vap_pressure[...]
    stream.vap_pressure[...]
    ...
    stream_results = {
        ...
        "henry_constant_comp": {"TCA": 0.3923},
        "saturation_vap_pressure": {"H2O": 1215.6},
        "vap_pressure": {"H2O": 0.0},
...
def test_properties2(m2):
    ...
    stream_results = {
        ...
        "henry_constant_comp": {"DCP": 0.0750617},
        "saturation_vap_pressure": {"H2O": 1215.5768},
        "vap_pressure": {"H2O": 607.7884},
...
def m3():
    ...
    props = {
        ...
        "saturation_vap_pressure_data": 1215.5768,
        "vap_pressure_data": 607.7884,
