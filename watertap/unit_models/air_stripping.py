...
from watertap.costing.unit_models.air_stripping import cost_air_stripping
...
@declare_process_block_class("AirStripping")
class AirStrippingData(InitializationMixin, UnitModelBlockData):
    """
    Air stripping / packed tower aeration zero dimensional model
    """
